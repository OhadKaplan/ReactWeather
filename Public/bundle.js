...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Navigation = function Navigation() {
	    return React.createElement(
	        ...
	        React.createElement(
	            IndexLink,
	            { to: '/', activeClassName: 'active', activeStyle: { fontWeight: 'bold', backgroundColor: 'gray' } },
	            'Get Weather'
	        ),
	        '\xA0',
	        React.createElement(
	            Link,
	            { to: 'about', activeClassName: 'active', activeStyle: { fontWeight: 'bold', backgroundColor: 'gray' } },
	            'About'
	        ),
	        ' \xA0',
	        React.createElement(
	            Link,
	            { to: 'examples', activeClassName: 'active', activeStyle: { fontWeight: 'bold', backgroundColor: 'gray' } },
	            'Examples'
	        )
	    );
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var OPERN_WEATHER_MAP_URL = 'https://api.openweathermap.org/data/2.5/weather?APPID=674357c923aa757d8fc05f4a1443a715&units=metric';
	...
	module.exports = {
	    ...
	    getTemp: function getTemp(location) {
	        ...
	        return axios.get(requetUrl).then(function (res) {
